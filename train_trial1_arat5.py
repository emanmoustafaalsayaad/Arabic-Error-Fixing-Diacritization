...
# Paths to data (2015 Only for Trial 1)
...
def train():
    # TRIAL 1 MODEL: AraT5-base
    model_name = "UBC-NLP/AraT5-base"
    print(f"Loading model: {model_name}")
    
    # TRIAL 1 FAILURE POINT: This tokenizer config caused vocab mismatch
    ...
    trainer.train()
    trainer.save_model("./final_gec_model_arat5")
